                            ...
                            <div class="w-full">
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="description" id="description" rows="6" maxlength="2000"
                                        class="block mt-1 w-full border-gray-300 dark:border-gray-700 
                                               ...
                                               dark:focus:ring-indigo-600 rounded-md shadow-sm"></textarea>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div id="lessons-wrapper" class="space-y-4">
                                        {{-- Initial lesson --}}
                                        <div
                                            class="lesson-item border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm p-4 relative bg-gray-50 dark:bg-gray-900">
                                            ...
                                            <div class="lesson-body mt-3 space-y-3">
                                                <div>
                                                    <x-input-label :value="__('Lesson Title')" />
                                                    <x-text-input type="text" name="lessons[0][title]"
                                                        class="mt-1 block w-full" required />
                                                </div>

                                                <div>
                                                    <x-input-label :value="__('Lesson Content')" />
                                                    <textarea name="lessons[0][content]" rows="3"
                                                        class="block mt-1 w-full border-gray-300 dark:border-gray-700 
                                               dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500  
                                               dark:focus:border-indigo-600 focus:ring-indigo-500   
                                               dark:focus:ring-indigo-600 rounded-md shadow-sm"></textarea>
                                                ...
                                                <div>
                                                    <x-input-label :value="__('Lesson File (optional)')" />
                                                    <input type="file" name="lessons[0][file]"
                                                        class="block mt-1 w-full border-gray-300 dark:border-gray-700 rounded-md" />
                                                </div>
                                            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        addLessonBtn.addEventListener("click", () => {
            ...
            lessonDiv.classList.add(
                "lesson-item", "border", "border-gray-300", "dark:border-gray-700",
        ...
        <div class="lesson-body mt-3 space-y-3">
            <div>
                ...
                <input type="text" name="lessons[${lessonIndex}][title]"
            ...
            <div>
                ...
                <textarea name="lessons[${lessonIndex}][content]" rows="3"
                    class="block mt-1 w-full border-gray-300 dark:border-gray-700 
                           dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500  
                           dark:focus:border-indigo-600 focus:ring-indigo-500  
                           dark:focus:ring-indigo-600 rounded-md shadow-sm"></textarea>
            ...
            <div>
                ...
                <input type="file" name="lessons[${lessonIndex}][file]"
                    class="block mt-1 w-full border-gray-300 dark:border-gray-700  
                                               dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500  
                                               dark:focus:border-indigo-600 focus:ring-indigo-500  
                                               dark:focus:ring-indigo-600 rounded-md shadow-sm">
