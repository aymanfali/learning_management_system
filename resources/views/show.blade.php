<x-main-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <a href="{{url('/')}}" class="text-gray-900 dark:text-gray-100 m-3"><< Go Back</a>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">

                <!-- Course Image -->
                <img src="{{ asset('storage/' . $course->image) ?? asset('favicon.icon') }}" alt="{{ $course->name }}"
                    class="w-full h-64 object-cover rounded-lg mb-6" loading="lazy">
